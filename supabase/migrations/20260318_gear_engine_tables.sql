-- Gear Engine Tables for Daily Drop System
-- Run this in Supabase SQL Editor to bootstrap the gear drop pipeline
-- Created: 2026-03-18

-- ============================================
-- TABLE 1: gear_catalog (source inventory)
-- ============================================
...
-- ============================================
-- TABLE 2: daily_drops (published drops -- Lovable reads this)
-- ============================================
...
-- ============================================
-- SEED DATA: 8 high-rated affiliate products
-- ============================================
