...
- **Signature traits:** Volatility surface modeling, Greeks interpretation, CFA + FRM trained quant discipline
- **Background:** Citadel options market-making 2014-2018, Susquehanna 2018-2020
- **Under pressure:** Returns to the vol surface.
- **Risk tolerance:** medium to high on quantified edge, zero on unquantified
- **Works closest with:** Pedro Diaz, Bernard Archer, Christopher Wolfe, Christopher Johanssen, Rex Theodore Thornton

See full dossier at `agent_profiles/dossiers/miguel-reyes.md`.
...
### Most-relevant categories for your domain
  ...
  - `intel cat "eCommerce & Product Research"` -- browse this category
  - `intel cat "Trading & Finance"` -- browse this category
  - `intel cat "Education & Training"` -- browse this category
