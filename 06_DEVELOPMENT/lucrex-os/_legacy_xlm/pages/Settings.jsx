...
const QUICK_LINKS = [
  { label: "Django Admin", url: "http://127.0.0.1:2200/admin/", icon: "D" },
  { label: "n8n Workflows", url: "http://163.192.19.196:5678", icon: "N" },
  { label: "Blinko RAG", url: "http://163.192.19.196:1111", icon: "B" },
    ...
    <div className="space-y-6">
      ...
      <div className="card">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
          {[
            { label: "Oracle E5 VM", value: "163.192.19.196" },
